...
class TokensController extends Zend_Controller_Action{
    ...
    public function init(){
     ...
     public function validarAction(){
        ...
        if ($this->getRequest()->getPost()){
            ...
            $result = $this->_tokns->Validarcorreo($post);
            //var_dump($post);exit;
            ...
            if(count($result)){
                foreach ($result as $key) {
                    ...
                    if (!empty($mail)){
                        ...
                        $tok= str_shuffle("abcdefghijklmnopqrstuvwxyz0123456789".uniqid());
                        //echo $tok;
                        $result = $this->_tokns->insertToken($mail,$table,$tok);
                        if ($result) {
                            
                            $nurl = '/home/nuevacontrasena/token/'.$tok;
                            

                            $cabeceras = 'MIME-Version: 1.0' . "\r\n"; 
                            $cabeceras .= 'Content-type: text/html; charset=iso-8859-1' . "\r\n";
                            $cabeceras .= 'To:'.$mail . "\r\n";
                            $cabeceras .= 'From: Recuperacion de Cuenta <GPSConstructivos>' . "\r\n";
  ...
  <head>
      ...
      <meta copyright="Copyright (c) 2020 GPSConstructivos. All Rights Reserved.">
      <style>
                    ...
                    <table align="left" width="100%" border="0" cellpadding="0" cellspacing="0" class="mcnImageContentContainer" style="min-width: 100%;border-collapse: collapse;mso-table-lspace: 0pt;mso-table-rspace: 0pt;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;">
                        <tbody><tr>
                            <td class="mcnImageContent" valign="top" style="padding-right: 9px;padding-left: 9px;padding-top: 0;padding-bottom: 0;text-align: center;mso-line-height-rule: exactly;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;">
                                    ...
                                    <a href="https://prueba.gpsc.com.mx./" title="" class="" target="_blank" style="mso-line-height-rule: exactly;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;">
                    ...
                    <tbody><tr>
                        ...
                        <td valign="top" class="mcnTextContent" style="padding-top: 0;padding-right: 18px;padding-bottom: 9px;padding-left: 18px;mso-line-height-rule: exactly;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;word-break: break-word;color: #202020;font-family: Helvetica;font-size: 16px;line-height: 150%;text-align: left;">
                            ...
                            <h1 style="display: block;margin: 0;padding: 0;color: #202020;font-family: Helvetica;font-size: 26px;font-style: normal;font-weight: bold;line-height: 125%;letter-spacing: normal;text-align: left;">
                                Solicitud de recuperaci&oacute;n de contrase&ntilde;a.
                            </h1>
                            <br>
                            <h3 style="display: block;margin: 0;padding: 0;color: #202020;font-family: Helvetica;font-size: 20px;font-style: normal;font-weight: bold;line-height: 125%;letter-spacing: normal;text-align: left;" >Hola: '.$mail.', Para Recuperar tu cuenta entra al siguiente link:</h3>
                                <h2 style="margin: 10px 0;padding: 0;mso-line-height-rule: exactly;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;color: #202020;font-family: Helvetica;font-size: 17px;line-height: 150%;text-align: left;">
                                    <a href="'.$host.'/home/nuevacontrasena/token/'.$tok.'" target="_blank">Recuperar contrase&ntilde;a</a> 
                                </h2>
    ...
    <tbody><tr>
        ...
        -->
                        ...
                        <!-- // END TEMPLATE -->
                            ...
                            if(mail($mail,"Recuperacion de cuenta GPSconstructivos.com.",$contenido,$cabeceras)){ 

                                // print '<script language="JavaScript">';
                                // print 'alert("Datos enviados correctamente, se enviara un correo con un link para que puedas cambiar tu contraseña");';
                                // print 'window.location = "/home/login";';
                                // print '</script>';
                                return $this-> _redirect('/home/successpass');
